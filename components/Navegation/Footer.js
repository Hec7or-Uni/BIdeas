      ...
      <div className="w-full mx-auto px-4">
        <ul className="max-w-screen-sm pt-12 mx-auto text-lg font-light flex flex-wrap justify-between">
          <li className="flex justify-center my-1">
            <a
              className="text-gray-500 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white transition-colors duration-200"
              href="/tos"
            >
              Terms of service
            </a>
        ...
        <div className=" flex w-full sm:w-1/3 pt-8 mx-auto items-center justify-around">
          ...
          >
            <svg
              ...
              height="20"
              fill="currentColor"
              className="text-xl hover:text-gray-900 dark:hover:text-white transition-colors duration-200"
          ...
          <a
            href="https://github.com/Hec7or-Uni/CoGS"
            className="text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors duration-200"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="text-center text-gray-500 dark:text-gray-200 pt-10 sm:pt-12 font-light flex items-center justify-center">
          Developed by
          <span className="px-1 hover:text-gray-900 dark:hover:text-white">
