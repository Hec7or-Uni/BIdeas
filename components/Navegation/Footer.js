...
export default function Footer(){
    ...
    <footer className="w-full py-8">
        <div className="w-full mx-auto px-4">
          <ul className="max-w-screen-md pt-12 mx-auto text-lg font-light flex flex-wrap justify-between">
              <li className="my-1">
                  <a className="text-gray-400 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="/tos">
                      Terms of service
                  </a>
              </li>
              <li className="my-1">
                  <a className="text-gray-400 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="/privacypolicy">
                      Privacy policy
                  </a>
              </li>
              <li className="my-1">
          ...
          <div className=" flex max-w-xs pt-8 mx-auto items-center justify-between">
              ...
              <a href="https://github.com/Hec7or-Uni/CoGS" className="text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
