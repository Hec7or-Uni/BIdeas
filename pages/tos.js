    ...
    <div className="container px-16 py-8 ">
      <div className="mx-auto flex flex-wrap items-center justify-center w-1/2 space-y-5 pb-10">
        ...
        <p className="text-justify">
          ...
          <span className="date">13/11/2021</span>. We expressly reserve the
        ...
        <p className="text-justify">
          ...
          then-current services on this Website shall also be subject to these
          Terms of Service. This Terms of Service was created by{" "}
          <a href="https://www.termsservicetemplate.com">
            Terms Service Template Generator
          </a>
          .
        </p>
        ...
        <p className="text-justify">
          ...
          under copyright of <span className="website_name">cogs</span> or its
          Affiliates. All other marks are property of their respective owners.
          Nothing in these Terms of Service grants you any right to use any
          trademark, service mark, logo, and/or the name or trade names of{" "}
        ...
        <p className="text-justify">
          ...
          or statement made by anyone other than an authorized{" "}
          <span className="website_name">cogs</span> spokesperson speaking in
          his/her official capacity. Please refer to the specific editorial
          policies posted on various sections of this Website for further
        ...
        <p className="text-justify">
          ...
          the internal laws of the <span className="country">es</span> without
        ...
        <p className="text-justify">
          ...
          in the federal courts of <span className="country">es</span>.
        </p>
      </div>
    </div>
  )
