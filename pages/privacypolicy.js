  ...
  return (
    <div className="container px-16 py-8 ">
      <div className="mx-auto flex flex-wrap items-center justify-center w-1/2 space-y-5 pb-10 dark:text-gray-300">
        <h1 className="dark:text-white px-2 py-2 font-bold text-2xl">
        ...
        <p className="text-justify">
          ...
          shared and/or collect in cogs. This policy is not applicable to any
        ...
        <h2 className="dark:text-white font-bold text-lg mr-1">Consent</h2>
        <p className="text-justify">
          By using our website, you hereby consent to our Privacy Policy and
          agree to its terms.
        </p>
        <h2 className="dark:text-white font-bold text-lg">
        ...
        <h2 className="dark:text-white font-bold text-lg mr-1">
        ...
        <h2 className="dark:text-white font-bold text-lg">Log Files</h2>
        <p className="text-justify">
          cogs follows a standard procedure of using log files. These files log
        ...
        <p className="text-justify">
          Like any other website, cogs uses &quot;cookies&quot;. These cookies
        ...
        <ul>
          <li>
            <p className="text-justify">Google</p>
            <p className="text-justify">
        ...
        <h2 className="ml-4 dark:text-white font-bold text-lg">
          Advertising Partners Privacy Policies
        </h2>
        <p className="text-justify">
          You may consult this list to find the Privacy Policy for each of the
          advertising partners of cogs.
        </p>
        <p className="text-justify">
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on cogs, which are sent directly
          to users&apos; browser. They automatically receive your IP address
          when this occurs. These technologies are used to measure the
          effectiveness of their advertising campaigns and/or to personalize the
          advertising content that you see on websites that you visit.
        </p>
        <p className="text-justify">
          Note that cogs has no access to or control over these cookies that are
        ...
        <p className="text-justify">
          cogs&apos;s Privacy Policy does not apply to other advertisers or
        ...
        <p className="text-justify">
          cogs does not knowingly collect any Personal Identifiable Information
