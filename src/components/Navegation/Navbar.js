        ...
        <nav className="flex items-center h-14 w-full bg-gray-200 z-50 tracking-wide">
            ...
            <div className="flex items-center h-12 absolute right-0 mr-8">
                ...
                <div>
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 mt-1.5 transition duration-500 ${isActive ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
